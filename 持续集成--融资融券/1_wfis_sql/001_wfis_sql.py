...
workspace = "D:\\jenkins\\workspace\\1_wfis_sql_dev"
# SVN_REVISION = os.getenv("SVN_REVISION")
SVN_REVISION = "28675"
# 引用参数end

# 声明全局变量pysvn.Revision,begin
revision_start = pysvn.Revision(pysvn.opt_revision_kind.number, Start_version)
revision_start1 = pysvn.Revision(pysvn.opt_revision_kind.number, Start_version + 1)
...
# os.system("svn diff --summarize -r Start_version %mysvn_url%/server>1.txt")
